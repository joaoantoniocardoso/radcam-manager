...
impl Default for ActuatorsParameters {
    fn default() -> Self {
        Self {
            ...
            script_channel: api::ServoChannel::SERVO10,
...
pub const CLOSEST_POINTS: &'static [api::FocusZoomPoint] = &[
    api::FocusZoomPoint {
        zoom: 900,
        focus: 882,
    },
...
pub const FURTHEST_POINTS: &'static [api::FocusZoomPoint] = &[
    api::FocusZoomPoint {
        zoom: 900,
        focus: 935,
    },
